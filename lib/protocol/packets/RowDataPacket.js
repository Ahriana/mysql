...
function numberConversion (input) {
  ...
  switch (field.type) {
    ...
    case Types.DOUBLE:
      ...
      if ((numberString === null || (field.zeroFill && numberString[0] === '0'))) {
        ...
        return numberConversion(numberString)
      }
    ...
    case Types.LONGLONG:
      ...
      if ((numberString === null || (field.zeroFill && numberString[0] === '0'))) {
        ...
        if ((supportBigNumbers && (bigNumberStrings || (Number(numberString) >= IEEE_754_BINARY_64_PRECISION) || Number(numberString) <= -IEEE_754_BINARY_64_PRECISION))) {
          return numberString
        } else {
          return numberConversion(numberString)
        }
